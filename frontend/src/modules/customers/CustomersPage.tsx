      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Link
              to="/customers/new"
              className="w-full sm:w-auto bg-black hover:bg-gray-800 text-white px-4 py-2.5 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 sm:mt-6">
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              type="submit"
              className="bg-black hover:bg-gray-800 text-white px-6 py-2.5 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-3 sm:gap-6 pt-4 border-t border-gray-200">
            ...
            <>
              ...
              <div className="sm:hidden divide-y divide-gray-200">
                {customers.map((customer) => (
                  <div
                    key={customer._id}
                    className={`p-4 ${customer.isBlocked ? 'bg-red-50' : ''}`}
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm font-mono text-gray-600 mt-1">{customer.cpfCnpj}</div>
                        </div>
                      </div>
                      <span
                        className={`px-2.5 py-1 inline-flex text-xs leading-5 font-medium rounded-full border ${customer.isBlocked
                    ...
                    <div className="flex justify-end gap-3 border-t border-gray-200 pt-3">
                      ...
                      <button
                        ...
                        className={`p-2 rounded hover:bg-gray-100 ${customer.isBlocked
                          ? 'text-green-600 hover:text-green-800'
                          : 'text-red-600 hover:text-red-800'
                          }`}
                        title={customer.isBlocked ? 'Desbloquear' : 'Bloquear'}
