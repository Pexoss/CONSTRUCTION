...
const ItemDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchOperationalStatus = async () => {
      try {
        const response = await inventoryService.getItemOperationalStatus(
          item._id,
        );
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                      ...
                      {item.lowStockThreshold &&
                        item.quantity.available <= item.lowStockThreshold && (
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-amber-50 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800/50">
                            <svg
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2">
                      <span className="inline-flex items-center px-3 py-1 rounded-md text-sm bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                        <svg
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex gap-3">
                  <Link
                    ...
                    className="inline-flex items-center justify-center px-4 py-2.5 bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white rounded-lg text-sm font-medium shadow-sm hover:shadow transition-all duration-200 min-w-[100px]"
                  >
                    <svg
                  ...
                  <button
                    onClick={() =>
                      setShowAdjustModal && setShowAdjustModal(true)
                    }
                    className="inline-flex items-center justify-center px-4 py-2.5 bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white rounded-lg text-sm font-medium shadow-sm hover:shadow transition-all duration-200 min-w-[100px]"
                  >
                    <svg
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {item.description && (
                    <div className="md:col-span-2 space-y-1">
                      ...
                      <dd className="text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg">
                        {item.description}
                      </dd>
                    </div>
                  )}
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {[
                    ...
                    <div
                      key={idx}
                      className={`${stat.bgColor} p-4 rounded-lg text-center border border-gray-200 dark:border-gray-700`}
                    >
                      <div className="flex items-center justify-center mb-2">
                        <svg
                          className={`h-5 w-5 ${stat.textColor} mr-1.5`}
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center px-4 py-2.5 bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white rounded-lg text-sm font-medium shadow-sm hover:shadow transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                    >
                    ...
                    {item.photos.map((photo, idx) => (
                      <div key={idx} className="relative group">
                        <img
                          src={photo}
                          alt={`${item.name} ${idx + 1}`}
                          className="w-full h-56 object-cover rounded-lg shadow-sm group-hover:shadow-md transition-all duration-300"
                        />
                        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 rounded-lg transition-all duration-300 flex items-center justify-center">
                          <button className="opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 p-2 bg-white rounded-full shadow-sm">
                            <svg
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${
                          operationalStatus?.status === "rented"
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-sm font-semibold text-gray-900 dark:text-white">
                            {operationalStatus.supplierName}
                          </span>
                        </div>
                  ...
                  <div className="px-6 py-6 space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 dark:focus:ring-gray-500 focus:border-gray-400 dark:focus:border-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"
                      >
                        <option value="in" className="py-2">
                          Entrada (Adicionar estoque)
                        </option>
                        <option value="out" className="py-2">
                          Saída (Remover estoque)
                        </option>
                        <option value="adjustment" className="py-2">
                          Ajuste Manual
                        </option>
                        <option value="damage" className="py-2">
                          Danificar
                        </option>
                        <option value="repair" className="py-2">
                          Reparar
                        </option>
                      </select>
                    </div>
