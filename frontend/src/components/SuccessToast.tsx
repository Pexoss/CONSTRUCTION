...
export const SuccessToast: React.FC<Props> = ({ message, description, onClose }) => {
  return createPortal(
    <div className="fixed top-5 right-5 z-[10050] bg-green-100 border border-green-400 text-green-900 px-6 py-4 rounded-lg shadow-lg flex items-start gap-3 animate-slide-in">
      <div>
